    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="mt-20 flex ">
          <img
            src={zeki}
            className="border border-gray-600 rounded-[20px] h-80 w-80 object-cover "
          />
        </div>
        <div className=" flex items-center">
          <div>
            ...
            >
              ...
              and expertise in frameworks like React and Node.js . I'm a quick
